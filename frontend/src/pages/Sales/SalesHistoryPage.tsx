...
export const SalesHistoryPage: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', alignItems: 'flex-end' }}>
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input
                type="text"
                placeholder="INV-2026-00001 or Customer name..."
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                style={{ width: '100%', padding: '0.55rem 0.75rem 0.55rem 2.2rem', backgroundColor: 'var(--bg-input)', border: '1px solid var(--border-medium)', borderRadius: '0.5rem', color: 'var(--text-main)', fontSize: '0.8125rem', outline: 'none' }}
              />
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            <Button variant="primary" icon={<Filter size={14} />} onClick={fetchSales} style={{ flex: 1 }}>
              Apply
            </Button>
            <Button
              variant="outline"
      ...
      <Card title={`Sales Invoices (${sales.length})`} subtitle="Official financial receipts generated from POS terminals" icon={<Receipt size={20} />}>
        {loading ? (
      ...
      {returnTargetSale && (
        ...
        >
          <form onSubmit={handleConfirmReturn} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            >
              <span style={{ fontSize: '0.875rem', fontWeight: 700 }}>Total Refund Due:</span>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '0.75rem' }}>
              ...
              >
                Confirm Return (Rs. {formatMoney(totalRefundAmount)})
              </Button>
            </div>
          </form>
        </Modal>
