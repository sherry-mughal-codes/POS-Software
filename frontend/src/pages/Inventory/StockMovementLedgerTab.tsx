...
export const StockMovementLedgerTab: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      {/* Movements Table */}
      <Card
        title={`Stock Movement Transactions (${filteredMovements.length})`}
        subtitle="Chronological audit log of every quantity increment and decrement in the system"
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.875rem' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid var(--border-medium)', color: 'var(--text-muted)' }}>
                  ...
                  <th style={{ padding: '0.75rem 1rem', fontWeight: 600, textAlign: 'right' }}>Unit Cost</th>
                  <th style={{ padding: '0.75rem 1rem', fontWeight: 600, textAlign: 'right' }}>Cost Value</th>
                  <th style={{ padding: '0.75rem 1rem', fontWeight: 600, textAlign: 'right' }}>Balance After</th>
                  ...
                  filteredMovements.map((m) => (
                    ...
                    >
                      ...
                      <td style={{ padding: '0.875rem 1rem' }}>
                        <div style={{ fontWeight: 700, color: 'var(--text-main)' }}>{m.product_name}</div>
                        <code style={{ fontSize: '0.75rem', color: 'var(--primary-400)' }}>{m.product_sku}</code>
                      </td>
                      ...
                      <td style={{ padding: '0.875rem 1rem', textAlign: 'right', fontFamily: 'var(--font-mono)', fontWeight: 600 }}>
                      ...
                      <td style={{ padding: '0.875rem 1rem' }}>
                        {m.reference_id ? (
                          <div>
                            <code style={{ fontSize: '0.8125rem', fontWeight: 600 }}>{m.reference_id}</code>
                            {m.notes && (
