...
class ReferenceType(models.TextChoices):
    ...
    COMMISSION_ACCRUAL = "COMMISSION_ACCRUAL", "Sales Commission Accrual"
    COMMISSION_PAYMENT = "COMMISSION_PAYMENT", "Sales Commission Payment"
    COMMISSION_REVERSAL = "COMMISSION_REVERSAL", "Sales Commission Reversal / Adjustment"
