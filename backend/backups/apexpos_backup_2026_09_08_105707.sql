...
\restrict OwtWbJSdDECcyjniybmjlCBgoLVKEcg0KasDy0Sn7eW6AqayZXPIN9IDxXnNx9h
...
ALTER TABLE IF EXISTS ONLY public.commission_salesagent DROP CONSTRAINT IF EXISTS commission_salesagent_created_by_id_7396f7a2_fk_auth_user_id;
...
DROP INDEX IF EXISTS public.core_systemmodule_key_63fe8135_like;
DROP INDEX IF EXISTS public.core_systemmodule_is_enabled_da2d6671;
...
DROP INDEX IF EXISTS public.commission_salesagent_phone_c8f3883f_like;
DROP INDEX IF EXISTS public.commission_salesagent_phone_c8f3883f;
DROP INDEX IF EXISTS public.commission_salesagent_name_a3581546_like;
DROP INDEX IF EXISTS public.commission_salesagent_name_a3581546;
DROP INDEX IF EXISTS public.commission_salesagent_is_active_d91cca2c;
DROP INDEX IF EXISTS public.commission_salesagent_created_by_id_7396f7a2;
DROP INDEX IF EXISTS public.commission_salesagent_created_at_bd909900;
DROP INDEX IF EXISTS public.commission_salesagent_code_dd0154aa_like;
...
ALTER TABLE IF EXISTS ONLY public.core_systemmodule DROP CONSTRAINT IF EXISTS core_systemmodule_pkey;
ALTER TABLE IF EXISTS ONLY public.core_systemmodule DROP CONSTRAINT IF EXISTS core_systemmodule_key_key;
...
ALTER TABLE IF EXISTS ONLY public.commission_salesagent DROP CONSTRAINT IF EXISTS commission_salesagent_pkey;
ALTER TABLE IF EXISTS ONLY public.commission_salesagent DROP CONSTRAINT IF EXISTS commission_salesagent_code_key;
...
DROP TABLE IF EXISTS public.core_systemmodule;
...
DROP TABLE IF EXISTS public.commission_salesagent;
...
--
-- Name: commission_salesagent; Type: TABLE; Schema: public; Owner: pos_user
--

CREATE TABLE public.commission_salesagent (
    id bigint NOT NULL,
    name character varying(150) NOT NULL,
...
ALTER TABLE public.commission_salesagent OWNER TO pos_user;

--
-- Name: commission_salesagent_id_seq; Type: SEQUENCE; Schema: public; Owner: pos_user
--

ALTER TABLE public.commission_salesagent ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.commission_salesagent_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: core_systemmodule; Type: TABLE; Schema: public; Owner: pos_user
--

CREATE TABLE public.core_systemmodule (
    id bigint NOT NULL,
    ...
    created_at timestamp with time zone NOT NULL,
    updated_at timestamp with time zone NOT NULL,
    CONSTRAINT core_systemmodule_display_order_check CHECK ((display_order >= 0))
);


ALTER TABLE public.core_systemmodule OWNER TO pos_user;

--
-- Name: core_systemmodule_id_seq; Type: SEQUENCE; Schema: public; Owner: pos_user
--

ALTER TABLE public.core_systemmodule ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.core_systemmodule_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
INSERT INTO public.accounting_journalentry VALUES (36344, 'JE-00001', '2026-09-07', '2026-09-07 11:33:39.989512+00', 'OPENING_BALANCE', 'OPN-PRD-00001', 'POSTED', 'Opening Stock Setup: Oreo Chocolate Sandwich Cookies 120g (50.00 units @ Rs. 30.00)', '2026-09-07 11:33:39.897808+00', '2026-09-07 11:33:39.897896+00', 1);
INSERT INTO public.accounting_journalentry VALUES (36345, 'JE-00002', '2026-09-07', '2026-09-07 13:03:09.900065+00', 'SALE', 'INV-00001', 'POSTED', 'POS Sale Invoice: INV-00001 (Walk-in Customer)', '2026-09-07 13:03:09.834202+00', '2026-09-07 13:03:09.834238+00', 1);
INSERT INTO public.accounting_journalentry VALUES (36346, 'JE-00003', '2026-09-07', '2026-09-07 13:03:10.006697+00', 'SALE', 'INV-00001', 'POSTED', 'COGS recognition for POS Sale: INV-00001', '2026-09-07 13:03:09.956545+00', '2026-09-07 13:03:09.956572+00', 1);
INSERT INTO public.accounting_journalentry VALUES (36347, 'JE-00004', '2026-09-07', '2026-09-07 13:05:59.572597+00', 'SALE', 'INV-00002', 'POSTED', 'POS Sale Invoice: INV-00002 (Walk-in Customer)', '2026-09-07 13:05:59.529245+00', '2026-09-07 13:05:59.529358+00', 1);
INSERT INTO public.accounting_journalentry VALUES (36348, 'JE-00005', '2026-09-07', '2026-09-07 13:05:59.671368+00', 'SALE', 'INV-00002', 'POSTED', 'COGS recognition for POS Sale: INV-00002', '2026-09-07 13:05:59.618498+00', '2026-09-07 13:05:59.618651+00', 1);
INSERT INTO public.accounting_journalentry VALUES (36349, 'JE-00006', '2026-09-07', '2026-09-07 13:06:40.335314+00', 'SALE', 'INV-00003', 'POSTED', 'POS Sale Invoice: INV-00003 (Walk-in Customer)', '2026-09-07 13:06:40.218631+00', '2026-09-07 13:06:40.218654+00', 1);
INSERT INTO public.accounting_journalentry VALUES (36350, 'JE-00007', '2026-09-07', '2026-09-07 13:06:40.488108+00', 'SALE', 'INV-00003', 'POSTED', 'COGS recognition for POS Sale: INV-00003', '2026-09-07 13:06:40.407952+00', '2026-09-07 13:06:40.408127+00', 1);
INSERT INTO public.accounting_journalentry VALUES (36351, 'JE-00008', '2026-09-08', '2026-09-08 06:58:39.649003+00', 'SALE', 'INV-00004', 'POSTED', 'POS Sale Invoice: INV-00004 (Walk-in Customer)', '2026-09-08 06:58:39.534365+00', '2026-09-08 06:58:39.534472+00', 1);
INSERT INTO public.accounting_journalentry VALUES (36352, 'JE-00009', '2026-09-08', '2026-09-08 06:58:39.783076+00', 'SALE', 'INV-00004', 'POSTED', 'COGS recognition for POS Sale: INV-00004', '2026-09-08 06:58:39.725574+00', '2026-09-08 06:58:39.726502+00', 1);
INSERT INTO public.accounting_journalentry VALUES (36353, 'JE-00010', '2026-09-08', '2026-09-08 06:59:05.159973+00', 'SALE', 'INV-00005', 'POSTED', 'POS Sale Invoice: INV-00005 (Walk-in Customer)', '2026-09-08 06:59:05.120956+00', '2026-09-08 06:59:05.12098+00', 1);
INSERT INTO public.accounting_journalentry VALUES (36354, 'JE-00011', '2026-09-08', '2026-09-08 06:59:05.266253+00', 'SALE', 'INV-00005', 'POSTED', 'COGS recognition for POS Sale: INV-00005', '2026-09-08 06:59:05.208455+00', '2026-09-08 06:59:05.208803+00', 1);
...
INSERT INTO public.accounting_journalitem VALUES (72914, 1500.00, 0.00, 'Opening inventory asset for Oreo Chocolate Sandwich Cookies 120g (50.00 @ Rs. 30.00)', 6, 36344);
INSERT INTO public.accounting_journalitem VALUES (72915, 0.00, 1500.00, 'Opening capital equity from product inventory (Oreo Chocolate Sandwich Cookies 120g)', 13, 36344);
INSERT INTO public.accounting_journalitem VALUES (72916, 40.00, 0.00, 'Payment received (Cash in Hand (Main Drawer)) for INV-00001', 33, 36345);
INSERT INTO public.accounting_journalitem VALUES (72917, 0.00, 40.00, 'Sales Revenue for INV-00001', 16, 36345);
INSERT INTO public.accounting_journalitem VALUES (72918, 30.00, 0.00, 'Cost of Goods Sold for INV-00001', 21, 36346);
INSERT INTO public.accounting_journalitem VALUES (72919, 0.00, 30.00, 'Inventory reduction for INV-00001', 6, 36346);
INSERT INTO public.accounting_journalitem VALUES (72920, 40.00, 0.00, 'Payment received (Cash in Hand (Main Drawer)) for INV-00002', 33, 36347);
INSERT INTO public.accounting_journalitem VALUES (72921, 0.00, 40.00, 'Sales Revenue for INV-00002', 16, 36347);
INSERT INTO public.accounting_journalitem VALUES (72922, 30.00, 0.00, 'Cost of Goods Sold for INV-00002', 21, 36348);
INSERT INTO public.accounting_journalitem VALUES (72923, 0.00, 30.00, 'Inventory reduction for INV-00002', 6, 36348);
INSERT INTO public.accounting_journalitem VALUES (72924, 40.00, 0.00, 'Payment received (Cash in Hand (Main Drawer)) for INV-00003', 33, 36349);
INSERT INTO public.accounting_journalitem VALUES (72925, 10.00, 0.00, 'Discount allowed on INV-00003', 17, 36349);
INSERT INTO public.accounting_journalitem VALUES (72926, 0.00, 50.00, 'Sales Revenue for INV-00003', 16, 36349);
INSERT INTO public.accounting_journalitem VALUES (72927, 30.00, 0.00, 'Cost of Goods Sold for INV-00003', 21, 36350);
INSERT INTO public.accounting_journalitem VALUES (72928, 0.00, 30.00, 'Inventory reduction for INV-00003', 6, 36350);
INSERT INTO public.accounting_journalitem VALUES (72929, 50.00, 0.00, 'Payment received (Cash in Hand (Main Drawer)) for INV-00004', 33, 36351);
INSERT INTO public.accounting_journalitem VALUES (72930, 0.00, 50.00, 'Sales Revenue for INV-00004', 16, 36351);
INSERT INTO public.accounting_journalitem VALUES (72931, 30.00, 0.00, 'Cost of Goods Sold for INV-00004', 21, 36352);
INSERT INTO public.accounting_journalitem VALUES (72932, 0.00, 30.00, 'Inventory reduction for INV-00004', 6, 36352);
INSERT INTO public.accounting_journalitem VALUES (72933, 60.00, 0.00, 'Payment received (Cash in Hand (Main Drawer)) for INV-00005', 33, 36353);
INSERT INTO public.accounting_journalitem VALUES (72934, 0.00, 60.00, 'Sales Revenue for INV-00005', 16, 36353);
INSERT INTO public.accounting_journalitem VALUES (72935, 30.00, 0.00, 'Cost of Goods Sold for INV-00005', 21, 36354);
INSERT INTO public.accounting_journalitem VALUES (72936, 0.00, 30.00, 'Inventory reduction for INV-00005', 6, 36354);
...
INSERT INTO public.auth_group_permissions VALUES (1021, 1, 181);
INSERT INTO public.auth_group_permissions VALUES (1022, 1, 182);
INSERT INTO public.auth_group_permissions VALUES (1023, 1, 183);
INSERT INTO public.auth_group_permissions VALUES (1024, 1, 184);
INSERT INTO public.auth_group_permissions VALUES (1025, 1, 185);
INSERT INTO public.auth_group_permissions VALUES (1026, 1, 186);
INSERT INTO public.auth_group_permissions VALUES (1027, 1, 187);
INSERT INTO public.auth_group_permissions VALUES (1028, 1, 188);
INSERT INTO public.auth_group_permissions VALUES (1029, 1, 189);
INSERT INTO public.auth_group_permissions VALUES (1030, 1, 190);
INSERT INTO public.auth_group_permissions VALUES (1031, 1, 191);
INSERT INTO public.auth_group_permissions VALUES (1032, 1, 192);
INSERT INTO public.auth_group_permissions VALUES (1033, 1, 193);
INSERT INTO public.auth_group_permissions VALUES (1034, 1, 194);
INSERT INTO public.auth_group_permissions VALUES (1035, 1, 195);
INSERT INTO public.auth_group_permissions VALUES (1036, 1, 196);
INSERT INTO public.auth_group_permissions VALUES (1037, 1, 197);
INSERT INTO public.auth_group_permissions VALUES (1038, 1, 198);
INSERT INTO public.auth_group_permissions VALUES (1039, 1, 199);
...
INSERT INTO public.auth_permission VALUES (200, 'Can add System Module', 45, 'add_systemmodule');
INSERT INTO public.auth_permission VALUES (201, 'Can change System Module', 45, 'change_systemmodule');
INSERT INTO public.auth_permission VALUES (202, 'Can delete System Module', 45, 'delete_systemmodule');
INSERT INTO public.auth_permission VALUES (203, 'Can view System Module', 45, 'view_systemmodule');
INSERT INTO public.auth_permission VALUES (204, 'Can view sales agent profiles and master directory', 8, 'view_sales_agents');
INSERT INTO public.auth_permission VALUES (205, 'Can create, update, and manage sales agents', 8, 'manage_sales_agents');
INSERT INTO public.auth_permission VALUES (206, 'Can add Sales Agent', 46, 'add_salesagent');
INSERT INTO public.auth_permission VALUES (207, 'Can change Sales Agent', 46, 'change_salesagent');
INSERT INTO public.auth_permission VALUES (208, 'Can delete Sales Agent', 46, 'delete_salesagent');
INSERT INTO public.auth_permission VALUES (209, 'Can view Sales Agent', 46, 'view_salesagent');
...
INSERT INTO public.auth_user VALUES (1, 'pbkdf2_sha256$720000$mz3hew1EIei6k6hfQX8ljQ$weW7sEq2o0iagULEVncVc2UQ+3DnKtzRcFfZHM627jo=', NULL, true, 'admin', 'System', 'Administrator', 'admin@apexpos.local', true, true, '2026-08-16 11:47:44.911996+00');
...
--
-- Data for Name: commission_salesagent; Type: TABLE DATA; Schema: public; Owner: pos_user
--

INSERT INTO public.commission_salesagent VALUES (1, 'Tariq Mahmood', 'AGT-0001', '+92 300 1234567', 'tariq@agents.local', 'Office 4B, Blue Area, Islamabad', 5.50, '2026-01-15', true, 'Top performing retail sales agent', '2026-09-08 10:40:01.397537+00', '2026-09-08 10:40:01.492377+00', 1);
INSERT INTO public.commission_salesagent VALUES (2, 'Tariq Mahmood', 'AGT-0002', '+92 300 1234567', 'tariq@agents.local', 'Office 4B, Blue Area, Islamabad', 5.50, '2026-01-15', true, 'Top performing retail sales agent', '2026-09-08 10:50:51.805182+00', '2026-09-08 10:50:51.903859+00', 1);
...
INSERT INTO public.core_auditlog VALUES (354, 'System Scheduler', 'BACKUP_CREATED', 'DatabaseBackup', '11', NULL, NULL, '{"status": "LOCAL_ONLY", "filename": "apexpos_backup_2026_09_07_101134.sql", "file_size": 303346, "backup_type": "AUTOMATIC_DAILY"}', '2026-09-07 10:11:36.163544+00', NULL);
INSERT INTO public.core_auditlog VALUES (355, 'admin', 'ROLE_MODIFIED', 'Role', '1', '172.18.0.1', NULL, '{"operation": "update", "role_name": "Administrator"}', '2026-09-08 07:25:02.284739+00', 1);
INSERT INTO public.core_auditlog VALUES (356, 'admin', 'ROLE_MODIFIED', 'Role', '1', '172.18.0.1', NULL, '{"operation": "update", "role_name": "Administrator"}', '2026-09-08 07:25:22.831882+00', 1);
INSERT INTO public.core_auditlog VALUES (357, 'admin', 'DATABASE_RESTORED', 'DatabaseBackup', '12', NULL, NULL, '{"filename": "imported_2026_09_08_074038_apexpos_backup_2026_09_08_072542.sql", "file_size": 315780}', '2026-09-08 07:41:16.7353+00', 1);
INSERT INTO public.core_auditlog VALUES (358, 'admin', 'SETTINGS_UPDATED', 'SystemModule', 'commission_management', '127.0.0.1', NULL, '{"module_key": "commission_management", "module_name": "Commission Management", "new_enabled_state": true}', '2026-09-08 10:40:01.31864+00', 1);
INSERT INTO public.core_auditlog VALUES (359, 'admin', 'USER_CREATED', 'SalesAgent', '1', '127.0.0.1', NULL, '{"agent_code": "AGT-0001", "agent_name": "Tariq Mahmood", "commission_percentage": "5.50"}', '2026-09-08 10:40:01.404943+00', 1);
INSERT INTO public.core_auditlog VALUES (360, 'admin', 'USER_DEACTIVATED', 'SalesAgent', '1', '127.0.0.1', NULL, '{"agent_code": "AGT-0001", "new_active_status": false}', '2026-09-08 10:40:01.477516+00', 1);
INSERT INTO public.core_auditlog VALUES (361, 'admin', 'USER_ACTIVATED', 'SalesAgent', '1', '127.0.0.1', NULL, '{"agent_code": "AGT-0001", "new_active_status": true}', '2026-09-08 10:40:01.514741+00', 1);
INSERT INTO public.core_auditlog VALUES (362, 'admin', 'SETTINGS_UPDATED', 'SystemModule', 'commission_management', '127.0.0.1', NULL, '{"module_key": "commission_management", "module_name": "Commission Management", "new_enabled_state": false}', '2026-09-08 10:40:01.529114+00', 1);
INSERT INTO public.core_auditlog VALUES (363, 'admin', 'SETTINGS_UPDATED', 'SystemModule', 'commission_management', '127.0.0.1', NULL, '{"module_key": "commission_management", "module_name": "Commission Management", "new_enabled_state": true}', '2026-09-08 10:40:01.55147+00', 1);
INSERT INTO public.core_auditlog VALUES (364, 'admin', 'SETTINGS_UPDATED', 'SystemModule', 'commission_management', '127.0.0.1', NULL, '{"module_key": "commission_management", "module_name": "Commission Management", "new_enabled_state": true}', '2026-09-08 10:50:51.728069+00', 1);
INSERT INTO public.core_auditlog VALUES (365, 'admin', 'USER_CREATED', 'SalesAgent', '2', '127.0.0.1', NULL, '{"agent_code": "AGT-0002", "agent_name": "Tariq Mahmood", "commission_percentage": "5.50"}', '2026-09-08 10:50:51.809567+00', 1);
INSERT INTO public.core_auditlog VALUES (366, 'admin', 'USER_DEACTIVATED', 'SalesAgent', '2', '127.0.0.1', NULL, '{"agent_code": "AGT-0002", "new_active_status": false}', '2026-09-08 10:50:51.885251+00', 1);
INSERT INTO public.core_auditlog VALUES (367, 'admin', 'USER_ACTIVATED', 'SalesAgent', '2', '127.0.0.1', NULL, '{"agent_code": "AGT-0002", "new_active_status": true}', '2026-09-08 10:50:51.907994+00', 1);
INSERT INTO public.core_auditlog VALUES (368, 'admin', 'SETTINGS_UPDATED', 'SystemModule', 'commission_management', '127.0.0.1', NULL, '{"module_key": "commission_management", "module_name": "Commission Management", "new_enabled_state": false}', '2026-09-08 10:50:51.927015+00', 1);
INSERT INTO public.core_auditlog VALUES (369, 'admin', 'SETTINGS_UPDATED', 'SystemModule', 'commission_management', '127.0.0.1', NULL, '{"module_key": "commission_management", "module_name": "Commission Management", "new_enabled_state": true}', '2026-09-08 10:50:51.95476+00', 1);
INSERT INTO public.core_auditlog VALUES (370, 'admin', 'USER_UPDATED', 'User', '1', '172.18.0.1', NULL, '{"is_active": true, "updated_username": "admin"}', '2026-09-08 10:56:13.873744+00', 1);
INSERT INTO public.core_auditlog VALUES (371, 'admin', 'LOGOUT', NULL, NULL, '172.18.0.1', NULL, '{}', '2026-09-08 10:56:27.048548+00', 1);
INSERT INTO public.core_auditlog VALUES (372, 'admin', 'LOGIN', NULL, NULL, '172.18.0.1', NULL, '{"roles": ["Administrator"]}', '2026-09-08 10:56:34.850873+00', 1);
...
INSERT INTO public.core_backuplog VALUES (11, 'apexpos_backup_2026_09_07_101134.sql', '/app/backups/apexpos_backup_2026_09_07_101134.sql', 303346, 'AUTOMATIC_DAILY', 'LOCAL_ONLY', NULL, NULL, '2026-09-07 10:11:36.153138+00', NULL);
INSERT INTO public.core_backuplog VALUES (12, 'imported_2026_09_08_074038_apexpos_backup_2026_09_08_072542.sql', '/app/backups/imported_2026_09_08_074038_apexpos_backup_2026_09_08_072542.sql', 315780, 'IMPORT_RESTORE', 'RESTORED', NULL, NULL, '2026-09-08 07:41:16.660592+00', 1);


--
-- Data for Name: core_systemmodule; Type: TABLE DATA; Schema: public; Owner: pos_user
--

INSERT INTO public.core_systemmodule VALUES (1, 'pos_register', 'POS Terminal & Registers', 'POS sales checkout, active register, and day session management', true, true, 10, '2026-09-08 10:39:11.405091+00', '2026-09-08 10:39:11.405195+00');
INSERT INTO public.core_systemmodule VALUES (2, 'sales', 'Sales & Invoicing', 'Customer invoicing, sales receipts, and sales returns', true, true, 20, '2026-09-08 10:39:11.424752+00', '2026-09-08 10:39:11.42479+00');
INSERT INTO public.core_systemmodule VALUES (3, 'purchases', 'Purchasing & Payables', 'Purchase orders, supplier bills, and supplier payments', true, true, 30, '2026-09-08 10:39:11.433841+00', '2026-09-08 10:39:11.43387+00');
INSERT INTO public.core_systemmodule VALUES (4, 'inventory', 'Inventory & Stock Control', 'Real-time stock ledger, product catalog, and stock adjustments', true, true, 40, '2026-09-08 10:39:11.446809+00', '2026-09-08 10:39:11.446851+00');
INSERT INTO public.core_systemmodule VALUES (5, 'customers', 'Customers & Receivables', 'Customer directory, credit limits, and receivable balances', true, true, 50, '2026-09-08 10:39:11.455027+00', '2026-09-08 10:39:11.455059+00');
INSERT INTO public.core_systemmodule VALUES (6, 'suppliers', 'Suppliers & Payables', 'Supplier directory, payment terms, and payable balances', true, true, 60, '2026-09-08 10:39:11.466393+00', '2026-09-08 10:39:11.466416+00');
INSERT INTO public.core_systemmodule VALUES (7, 'accounting', 'Double Entry Accounting', 'Chart of accounts, general ledger, and journal entries', true, true, 70, '2026-09-08 10:39:11.492951+00', '2026-09-08 10:39:11.492984+00');
INSERT INTO public.core_systemmodule VALUES (8, 'expenses', 'Expense Management', 'Expense categories and daily operational expense vouchers', true, true, 80, '2026-09-08 10:39:11.514404+00', '2026-09-08 10:39:11.51443+00');
INSERT INTO public.core_systemmodule VALUES (9, 'employees', 'Employees & Payroll', 'Employee directory, attendance, salary slips, and payroll payments', true, true, 90, '2026-09-08 10:39:11.525698+00', '2026-09-08 10:39:11.525729+00');
INSERT INTO public.core_systemmodule VALUES (10, 'warranty', 'Warranty Claims', 'Customer warranty replacements and supplier RMA claims', true, true, 100, '2026-09-08 10:39:11.535653+00', '2026-09-08 10:39:11.535676+00');
INSERT INTO public.core_systemmodule VALUES (11, 'reports', 'Analytics & Reports Center', 'Executive sales analytics, financial statements, and stock reports', true, true, 110, '2026-09-08 10:39:11.549647+00', '2026-09-08 10:39:11.549682+00');
INSERT INTO public.core_systemmodule VALUES (12, 'admin_security', 'Admin & Security', 'User management, role matrix, and security audit logs', true, true, 120, '2026-09-08 10:39:11.558817+00', '2026-09-08 10:39:11.558838+00');
INSERT INTO public.core_systemmodule VALUES (13, 'commission_management', 'Commission Management', 'Sales agent master directory, commission percentages, and commission lifecycle foundation', true, false, 200, '2026-09-08 10:39:11.566494+00', '2026-09-08 10:50:51.949327+00');
...
INSERT INTO public.django_content_type VALUES (45, 'core', 'systemmodule');
INSERT INTO public.django_content_type VALUES (46, 'commission', 'salesagent');
...
INSERT INTO public.django_migrations VALUES (63, 'accounting', '0005_alter_journalentry_options_and_more', '2026-09-08 10:37:47.820354+00');
INSERT INTO public.django_migrations VALUES (64, 'commission', '0001_initial', '2026-09-08 10:37:48.17996+00');
INSERT INTO public.django_migrations VALUES (65, 'contacts', '0006_alter_customer_options_alter_customerpayment_options_and_more', '2026-09-08 10:37:48.487658+00');
INSERT INTO public.django_migrations VALUES (66, 'core', '0004_systemmodule', '2026-09-08 10:37:48.573451+00');
INSERT INTO public.django_migrations VALUES (67, 'employees', '0003_alter_attendance_options_alter_employee_options_and_more', '2026-09-08 10:37:49.948452+00');
INSERT INTO public.django_migrations VALUES (68, 'expenses', '0004_alter_accounttransfer_options_alter_expense_options_and_more', '2026-09-08 10:37:50.450901+00');
INSERT INTO public.django_migrations VALUES (69, 'inventory', '0005_alter_stockadjustment_options_and_more', '2026-09-08 10:37:50.637382+00');
INSERT INTO public.django_migrations VALUES (70, 'products', '0005_alter_product_options', '2026-09-08 10:37:50.676284+00');
INSERT INTO public.django_migrations VALUES (71, 'purchases', '0009_alter_purchase_options_alter_purchasereturn_options_and_more', '2026-09-08 10:37:51.413759+00');
INSERT INTO public.django_migrations VALUES (72, 'sales', '0008_alter_sale_options_alter_salesreturn_options_and_more', '2026-09-08 10:37:52.191896+00');
INSERT INTO public.django_migrations VALUES (73, 'users', '0004_alter_pospermissionregistry_options', '2026-09-08 10:37:52.203229+00');
INSERT INTO public.django_migrations VALUES (74, 'warranty', '0002_alter_customerwarrantyclaim_options_and_more', '2026-09-08 10:37:52.818412+00');
...
INSERT INTO public.inventory_stockmovement VALUES (28132, 'OPENING_STOCK', 50.00, 30.00, 'OPENING_BALANCE', 'OPN-PRD-00001', 'Initial Opening Stock for Oreo Chocolate Sandwich Cookies 120g', '2026-09-07 11:33:39.643298+00', 82, 50.00, 1);
INSERT INTO public.inventory_stockmovement VALUES (28133, 'SALE', -1.00, 30.00, 'SALE', 'INV-00001', 'POS Sale to Walk-in Customer (INV-00001)', '2026-09-07 13:03:09.711003+00', 82, 49.00, 1);
INSERT INTO public.inventory_stockmovement VALUES (28134, 'SALE', -1.00, 30.00, 'SALE', 'INV-00002', 'POS Sale to Walk-in Customer (INV-00002)', '2026-09-07 13:05:59.415806+00', 82, 48.00, 1);
INSERT INTO public.inventory_stockmovement VALUES (28135, 'SALE', -1.00, 30.00, 'SALE', 'INV-00003', 'POS Sale to Walk-in Customer (INV-00003)', '2026-09-07 13:06:40.117763+00', 82, 47.00, 1);
INSERT INTO public.inventory_stockmovement VALUES (28136, 'SALE', -1.00, 30.00, 'SALE', 'INV-00004', 'POS Sale to Walk-in Customer (INV-00004)', '2026-09-08 06:58:39.363692+00', 82, 46.00, 1);
INSERT INTO public.inventory_stockmovement VALUES (28137, 'SALE', -1.00, 30.00, 'SALE', 'INV-00005', 'POS Sale to Walk-in Customer (INV-00005)', '2026-09-08 06:59:05.013066+00', 82, 45.00, 1);
...
INSERT INTO public.products_product VALUES (82, 'PRD-00001', 'Oreo Chocolate Sandwich Cookies 120g', NULL, 30.00, 50.00, '', NULL, NULL, true, '2026-09-07 11:33:06.001792+00', '2026-09-07 11:33:39.589994+00', 53, 27, 10.00, true, NULL);
...
INSERT INTO public.sales_posdaysession VALUES (1763, 'DAY-2026-09-07', '2026-09-07', 'CLOSED', 0.00, '2026-09-07 13:02:50.62444+00', NULL, '2026-09-08 07:23:00.918324+00', 230.00, 230.00, 0.00, NULL, NULL, '{"date": "2026-09-07", "sales": {"tax": 0.0, "discounts": 10.0, "net_sales": 230.0, "card_sales": 0.0, "cash_sales": 230.0, "gross_sales": 240.0, "cheque_sales": 0.0, "credit_sales": 0.0, "invoices_count": 5}, "status": "OPEN", "returns": {"bank_refunds": 0.0, "cash_refunds": 0.0, "returns_count": 0, "total_returns": 0.0, "credit_refunds": 0.0}, "expenses": {"bank": 0.0, "cash": 0.0, "count": 0, "total": 0.0}, "closed_at": null, "closed_by": null, "opened_at": "2026-09-07T13:02:50.624440+00:00", "opened_by": "System Administrator", "transfers": {"cash_transfers_in": 0.0, "cash_transfers_out": 0.0}, "session_id": 1763, "cash_drawer": {"opening_cash": 0.0, "expected_cash": 230.0, "total_cash_in": 230.0, "total_cash_out": 0.0}, "report_type": "Z_REPORT", "generated_at": "2026-09-08T07:23:00.918154+00:00", "opening_cash": 0.0, "closing_audit": {"closed_at": "2026-09-08T07:23:00.918220+00:00", "closed_by": "System Administrator", "actual_cash": 230.0, "closing_notes": null, "expected_cash": 230.0, "cash_difference": 0.0, "difference_type": "EXACT", "difference_reason": null}, "session_number": "DAY-2026-09-07", "salary_payments": {"bank": 0.0, "cash": 0.0, "count": 0, "total": 0.0}, "customer_payments": {"bank": 0.0, "cash": 0.0, "count": 0, "total": 0.0}, "supplier_payments": {"bank": 0.0, "cash": 0.0, "count": 0, "total": 0.0}}', '2026-09-07 13:02:50.630568+00', '2026-09-08 07:23:00.919895+00', 1, 1);
...
INSERT INTO public.sales_sale VALUES (4037, 'INV-00001', '2026-09-07', 'COMPLETED', 40.00, 0.00, 0.00, 40.00, 40.00, 0.00, 0.00, 'CASH', '', '2026-09-07 13:03:09.660586+00', '2026-09-07 13:03:09.660621+00', 1, 25, 33, '', NULL, '');
INSERT INTO public.sales_sale VALUES (4038, 'INV-00002', '2026-09-07', 'COMPLETED', 40.00, 0.00, 0.00, 40.00, 40.00, 0.00, 0.00, 'CASH', '', '2026-09-07 13:05:59.387103+00', '2026-09-07 13:05:59.387317+00', 1, 25, 33, '', NULL, '');
INSERT INTO public.sales_sale VALUES (4039, 'INV-00003', '2026-09-07', 'COMPLETED', 50.00, 10.00, 0.00, 40.00, 40.00, 0.00, 0.00, 'CASH', '', '2026-09-07 13:06:40.08869+00', '2026-09-07 13:06:40.088982+00', 1, 25, 33, '', NULL, '');
INSERT INTO public.sales_sale VALUES (4040, 'INV-00004', '2026-09-08', 'COMPLETED', 50.00, 0.00, 0.00, 50.00, 50.00, 0.00, 0.00, 'CASH', '', '2026-09-08 06:58:39.25034+00', '2026-09-08 06:58:39.251257+00', 1, 25, 33, '', NULL, '');
INSERT INTO public.sales_sale VALUES (4041, 'INV-00005', '2026-09-08', 'COMPLETED', 60.00, 0.00, 0.00, 60.00, 60.00, 0.00, 0.00, 'CASH', '', '2026-09-08 06:59:04.991929+00', '2026-09-08 06:59:04.992053+00', 1, 25, 33, '', NULL, '');
...
INSERT INTO public.sales_saleitem VALUES (7957, 1.00, 40.00, 30.00, 0.00, 40.00, 0.00, '2026-09-07 13:03:09.689282+00', 82, 4037, NULL, NULL);
INSERT INTO public.sales_saleitem VALUES (7958, 1.00, 50.00, 30.00, 10.00, 40.00, 0.00, '2026-09-07 13:05:59.404153+00', 82, 4038, NULL, NULL);
INSERT INTO public.sales_saleitem VALUES (7959, 1.00, 50.00, 30.00, 0.00, 50.00, 0.00, '2026-09-07 13:06:40.1019+00', 82, 4039, NULL, NULL);
INSERT INTO public.sales_saleitem VALUES (7960, 1.00, 50.00, 30.00, 0.00, 50.00, 0.00, '2026-09-08 06:58:39.340431+00', 82, 4040, NULL, NULL);
INSERT INTO public.sales_saleitem VALUES (7961, 1.00, 60.00, 30.00, 0.00, 60.00, 0.00, '2026-09-08 06:59:05.003786+00', 82, 4041, NULL, NULL);
...
INSERT INTO public.sales_salepayment VALUES (4254, 'CASH', 40.00, NULL, '2026-09-07 13:03:09.720339+00', 4037, 33, '', NULL, '');
INSERT INTO public.sales_salepayment VALUES (4255, 'CASH', 40.00, NULL, '2026-09-07 13:05:59.427573+00', 4038, 33, '', NULL, '');
INSERT INTO public.sales_salepayment VALUES (4256, 'CASH', 40.00, NULL, '2026-09-07 13:06:40.126268+00', 4039, 33, '', NULL, '');
INSERT INTO public.sales_salepayment VALUES (4257, 'CASH', 50.00, NULL, '2026-09-08 06:58:39.426938+00', 4040, 33, '', NULL, '');
INSERT INTO public.sales_salepayment VALUES (4258, 'CASH', 60.00, NULL, '2026-09-08 06:59:05.023076+00', 4041, 33, '', NULL, '');
...
INSERT INTO public.users_userprofile VALUES (1, '+1 555-0100', '9999', '', NULL, '2026-08-16 11:47:44.914174+00', '2026-09-08 10:56:13.855179+00', 1, 'ApexPOS Enterprise Store', 'ALL_COMPANY');
...
SELECT pg_catalog.setval('public.accounting_journalentry_id_seq', 36354, true);
...
SELECT pg_catalog.setval('public.accounting_journalitem_id_seq', 72936, true);
...
SELECT pg_catalog.setval('public.auth_group_permissions_id_seq', 1039, true);
...
--
-- Name: commission_salesagent_id_seq; Type: SEQUENCE SET; Schema: public; Owner: pos_user
--

SELECT pg_catalog.setval('public.commission_salesagent_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.core_auditlog_id_seq', 372, true);
...
SELECT pg_catalog.setval('public.core_backuplog_id_seq', 12, true);


--
-- Name: core_systemmodule_id_seq; Type: SEQUENCE SET; Schema: public; Owner: pos_user
--

SELECT pg_catalog.setval('public.core_systemmodule_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.inventory_stockmovement_id_seq', 28137, true);
...
SELECT pg_catalog.setval('public.sales_posdaysession_id_seq', 1763, true);
...
SELECT pg_catalog.setval('public.sales_sale_id_seq', 4041, true);
...
SELECT pg_catalog.setval('public.sales_saleitem_id_seq', 7961, true);
...
SELECT pg_catalog.setval('public.sales_salepayment_id_seq', 4258, true);
...
--
-- Name: commission_salesagent commission_salesagent_code_key; Type: CONSTRAINT; Schema: public; Owner: pos_user
--

ALTER TABLE ONLY public.commission_salesagent
    ADD CONSTRAINT commission_salesagent_code_key UNIQUE (code);


--
-- Name: commission_salesagent commission_salesagent_pkey; Type: CONSTRAINT; Schema: public; Owner: pos_user
--

ALTER TABLE ONLY public.commission_salesagent
    ADD CONSTRAINT commission_salesagent_pkey PRIMARY KEY (id);
...
--
-- Name: core_systemmodule core_systemmodule_key_key; Type: CONSTRAINT; Schema: public; Owner: pos_user
--

ALTER TABLE ONLY public.core_systemmodule
    ADD CONSTRAINT core_systemmodule_key_key UNIQUE (key);


--
-- Name: core_systemmodule core_systemmodule_pkey; Type: CONSTRAINT; Schema: public; Owner: pos_user
--

ALTER TABLE ONLY public.core_systemmodule
    ADD CONSTRAINT core_systemmodule_pkey PRIMARY KEY (id);
...
--
-- Name: commission_salesagent_code_dd0154aa_like; Type: INDEX; Schema: public; Owner: pos_user
--

CREATE INDEX commission_salesagent_code_dd0154aa_like ON public.commission_salesagent USING btree (code varchar_pattern_ops);


--
-- Name: commission_salesagent_created_at_bd909900; Type: INDEX; Schema: public; Owner: pos_user
--

CREATE INDEX commission_salesagent_created_at_bd909900 ON public.commission_salesagent USING btree (created_at);


--
-- Name: commission_salesagent_created_by_id_7396f7a2; Type: INDEX; Schema: public; Owner: pos_user
--

CREATE INDEX commission_salesagent_created_by_id_7396f7a2 ON public.commission_salesagent USING btree (created_by_id);


--
-- Name: commission_salesagent_is_active_d91cca2c; Type: INDEX; Schema: public; Owner: pos_user
--

CREATE INDEX commission_salesagent_is_active_d91cca2c ON public.commission_salesagent USING btree (is_active);


--
-- Name: commission_salesagent_name_a3581546; Type: INDEX; Schema: public; Owner: pos_user
--

CREATE INDEX commission_salesagent_name_a3581546 ON public.commission_salesagent USING btree (name);


--
-- Name: commission_salesagent_name_a3581546_like; Type: INDEX; Schema: public; Owner: pos_user
--

CREATE INDEX commission_salesagent_name_a3581546_like ON public.commission_salesagent USING btree (name varchar_pattern_ops);


--
-- Name: commission_salesagent_phone_c8f3883f; Type: INDEX; Schema: public; Owner: pos_user
--

CREATE INDEX commission_salesagent_phone_c8f3883f ON public.commission_salesagent USING btree (phone);


--
-- Name: commission_salesagent_phone_c8f3883f_like; Type: INDEX; Schema: public; Owner: pos_user
--

CREATE INDEX commission_salesagent_phone_c8f3883f_like ON public.commission_salesagent USING btree (phone varchar_pattern_ops);
...
--
-- Name: core_systemmodule_is_enabled_da2d6671; Type: INDEX; Schema: public; Owner: pos_user
--

CREATE INDEX core_systemmodule_is_enabled_da2d6671 ON public.core_systemmodule USING btree (is_enabled);


--
-- Name: core_systemmodule_key_63fe8135_like; Type: INDEX; Schema: public; Owner: pos_user
--

CREATE INDEX core_systemmodule_key_63fe8135_like ON public.core_systemmodule USING btree (key varchar_pattern_ops);
...
--
-- Name: commission_salesagent commission_salesagent_created_by_id_7396f7a2_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: pos_user
--

ALTER TABLE ONLY public.commission_salesagent
    ADD CONSTRAINT commission_salesagent_created_by_id_7396f7a2_fk_auth_user_id FOREIGN KEY (created_by_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;
...
\unrestrict OwtWbJSdDECcyjniybmjlCBgoLVKEcg0KasDy0Sn7eW6AqayZXPIN9IDxXnNx9h
